            ...
            <div className="top_navbar">
                <div className="d-flex justify-content-between align-items-center" id='mix_top_nav'>
                    <div className="email">
                        ...
                        <span className='email_span'>  freedomelectricalsolutions.com</span>
                    </div>
                    <div className="email">
                        <span className="envelope"><FaPhone /></span>
                        <span className='email_span'> +15124004157</span>
                    </div>
            ...
            <div className="con">
                ...
                <div id="mainListDiv" className="main_list">
                    <ul className="navlinks">
                        ...
                        <li><NavLink to="/Services" id='nav_link' onClick={() => handleActiveLink('Services')} className={activeLink === 'Services' ? 'active-link' : ''}>Sefaty</NavLink></li>
                        <li><NavLink to="/Skills" id='nav_link' onClick={() => handleActiveLink('Skills')} className={activeLink === 'Skills' ? 'active-link' : ''} >Services</NavLink></li>
