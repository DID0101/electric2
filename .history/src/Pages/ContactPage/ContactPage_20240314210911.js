      ...
      <div>
            <script>
                ...
                (function () {
                    ...
                    div.setAttribute('data-url', 'https://calendly.com/didarp/consulting-meeting?hide_event_type_details=1&hide_gdpr_banner=1');
                    ...
                    document.getElementById('calendly-widget').appendChild(div);
                })();
                `}
            </script>
            <div id="calendly-widget" style={{minWidth: '320px', height: '700px'}}></div>
        </div>
