                ...
                <div className="all_links d-flex">
                    <div>
                        <ul className="web_links">
                            ...
                            <li><Link to="/AboutMe" id='link'>About</Link></li>
                            <li><Link to="/Services" id='link'>Safety</Link></li>
                            <li><Link to="/Skills" id='link'>Services</Link></li>
                    ...
                    <div>
                        <ul className="social">
                            <h1>Social</h1>
                            <li><a href="https://www.instagram.com/freedom_electrical_solutions">instagram</a></li>
                            <li><a href="https://www.facebook.com/103183915317540">facebook</a></li>
